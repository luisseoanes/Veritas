    ...
    <DashCard interactive className="flex flex-col gap-5">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="flex items-start gap-3">
          <span className="mt-0.5 flex size-8 shrink-0 items-center justify-center rounded-lg bg-[var(--dash-danger-soft)] text-dash-danger">
            <PackageSearch className="size-4" strokeWidth={1.75} />
          </span>
          <div>
            <p className="tnum text-[1.5rem] font-semibold leading-none tracking-tight text-dash-text">
              {formatNumber(item.clientes_afectados)}
            </p>
            <p className="mt-1.5 text-[13px] text-dash-text-muted">clientes afectados</p>
            <p className="mt-0.5 text-[12px] text-dash-text-aux">
      ...
      <div className="grid grid-cols-2 gap-4 border-t border-dash-border pt-4">
      ...
      <div>
        <p className="mb-2 text-[12px] font-medium text-dash-text-aux">Restricción causante</p>
...
function BundleGapCard({ item }: { item: BundleGap }) {
  return (
    <DashCard interactive className="flex flex-col gap-5">
      <div className="flex items-start gap-3">
        <span className="mt-0.5 flex size-8 shrink-0 items-center justify-center rounded-lg bg-[var(--dash-accent-soft)] text-dash-accent">
          <Boxes className="size-4" strokeWidth={1.75} />
        </span>
        <div className="min-w-0">
          <p className="text-[15px] font-semibold leading-snug text-dash-text">
            {item.nombres.join(" + ")}
          </p>
          <p className="mt-1 font-mono text-[11px] text-dash-text-aux">
            {item.componentes.join(" · ")}
          </p>
        </div>
      </div>

      <div className="grid grid-cols-3 gap-4 border-t border-dash-border pt-4">
    ...
    <DashCard interactive className="flex flex-col gap-5">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            <p className="text-[15px] font-semibold leading-snug text-dash-text">{item.nombre}</p>
            <p className="mt-1 font-mono text-[11px] text-dash-text-aux">{item.componente}</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 gap-4 border-t border-dash-border pt-4 sm:grid-cols-4">
